...
Pokrývá úrovně **A1–B2** — přepínač úrovně řídí obsah celé appky. Režimy: 🎲 Mix, 📅 plánované opakování (Leitner: krabičky 1–5, intervaly 1/3/7/14/30 dní), 🔁 moje chyby, časování (7 časů), gramatická doplňování (členy, zájmena, subjonctif…), être/avoir v passé composé (dům slovesa être), passé composé × imparfait, slovíčka (slovesa i tematická zásoba), diktáty s vyhodnocením po slovech, porozumění textu ve stylu DELF (96 textů napříč A1–B2), čísla 0–100 (i poslechově, francouzský i švýcarský styl), rody un/une, 🇨🇭 švýcarská francouzština (helvétismes). K tomu denní cíl a série 🔥, volitelné psaní odpovědí, francouzské předčítání, možnost vyřadit ohrané položky z rotace, statistiky chyb a záloha/obnova pokroku.
